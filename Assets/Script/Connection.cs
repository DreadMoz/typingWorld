    ...
    private void getDummyGss()
    {
        ...
        if (gm.gssToggle.isOn)
        {
            ...
            ""response"": {
                ...
                ""result"": ""demonstration@e-net.nara.jp,/公立学校/低学年/OU市/OU小学校,0603-24,659,7,87,moru,6,0,121,3,202,0,0,333,122333444555666777,656279013556373800,476371964491057500,471305275021828740,511767441717405440,86064876791434,88,144115188075855870,8388608,0""
                }
            }";
        }
        else
